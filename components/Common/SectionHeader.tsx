...
const SectionHeader = ({ headerInfo,style }: { headerInfo: HeaderInfo,style:any }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <p className={`mx-auto ${style==='act'&&'text-gray-800 dark:text-gray-200'} md:w-4/5 lg:w-3/5 xl:w-[46%]`}>{description}</p>
      </motion.div>
      {/* <!-- Section Title End --> */}
    </>
  );
